                ...
                <div className="off-box container-body">
                    ...
                    <div className="   mb-4 boxoff-left row-ak ">
                        <div className="w-100 py-md-3 py-1 px-0 ">
                            ...
                            <div className="w-100 pt-3 slider-boxoff-left">

                            <ProductSlider>
                                    {Object.entries(products.suggest)?.map(([key, product]) =>
                                        <Product
                                            key={key}
                                            classes=''
                                            classp_0=""
