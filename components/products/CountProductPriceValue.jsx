...
function CountProductPriceValue(props) {
            ...
            <form   method="post" onSubmit={handleSubmit(cartSubmit)} className="pcp-hidden ajaxCart">
                                            ...
                                            <li className="list-group-item metraj">
                                                <div className="row">
                                                    ...
                                                    <div className="col-6 text-center mtr-con">
                                                        ...
                                                        <input type="text" min="0" className="form-control size-palet" defaultValue={count[key]} placeholder={product.avail_type} product="0" id="product_avail" name={`count[${key}]`} onChange={changeCount(key)} />
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 pt-2">
                    ...
                    <div className="product-params default parent-btn-sell">
                        ...
                        <div className="py-2 text-center text-success fontS-16" itemProp="offers" itemScope={1} itemType="http://schema.org/Offer">
                            {totalcount ?
                                <>
                                    {subtotal ?
                                        <>
...
export default withRouter(CountProductPriceValue);