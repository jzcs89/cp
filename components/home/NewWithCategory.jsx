...
import LoadingMini from "../sections/LoadingMini";
import Link from "next/link";
import Axios from "../../Services/Axios";
import { website } from "../../Services/Helper";
import ProductSlider from "../products/ProductSlider";
import { getNewWithCategory } from "../routesApi";
;

export default function NewWithCategory() {
    ...
    useMemo(() => {
        ...
        Axios({
            method: 'get',
            url: encodeURI(getNewWithCategory(category_slug)),// '/v1/get-new/with-category/' + category_slug,
            data: '',
                    ...
                    <div className="w-100 p-md-3 p-2">
                        <div className="">
                            <div className="boxoff-txt">
                                <p>جدیدترین ها <span className="d-none d-md-inline">  در سرام پخش</span></p>
                            </div>
