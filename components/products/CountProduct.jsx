...
import { AngleLeft, Spinner, StoreIcon } from '../../components/icons/SvgIcons';
...
function CountProduct(props) {
    ...
    useMemo(() => {
        ...
        if (process.browser) {
            document.cookie = `calculat-divar=0; path=/;max-age=` + 0;
            document.cookie = `calculat-kaf=0; path=/;max-age=` + 0;
        }
                        ...
                        <ul className="list-group">
                            {products &&
                                Object.entries(products)?.map(([key, product]) => 
                                            <li key={key} className="list-group-item metraj">
                                                <div className="row">
                                                    <div className="col-12 text-right px-0 pb-2">
                                                    ...
                                                    {(product.avail_type !== 'عدد' && product.avail_type !== 'مترمربع' && product.avail_type !== 'بسته') &&
                                                        <div className="col-6 text-center mtr-con">
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 pt-2">
                    <div className="product-params default parent-btn-sell p-1">
                        <div className=" text-center  fontS-16" itemProp="offers" itemScope={1} itemType="http://schema.org/Offer">
                            ...
                            {props.listBeranchesPrice.length > 1 &&
                                ...
                                <div className="my-2 default">
                                    ...
                                    <div className="w-100">
                                        <div className="row-ak basket-two">
                                            <div className="col-6 ">
                                                <button type="submit" className="  btn  w-100 btn-success" disabled={loder} onClick={() => setgoToCart(false)}>
                                                    {loder ?
                                            ...
                                            <div className="col-6 ">
                                                <button type="submit" className="btn  w-100 btn-firoozei" disabled={loder2} onClick={() => setgoToCart(true)}>
                                                    {loder2 ?
                                                        <Spinner className=" m-0 spinner fa-spin"/>
                                                        :
                                                        <>
