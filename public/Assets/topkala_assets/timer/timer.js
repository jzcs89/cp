function Timer(el) {
    ...
    this.HEIGHT = 200;
    this.TIMER_BORDER = 3;
    this.TIMER_COLOR1 = "#1fc8db";
    this.TIMER_COLOR2 = "#d2d2d2";
    this.TIMER_DURATION = dateExpire;
    this.TIME_ELAPSED = 0;
    this.DOT_RADIUS = 6;
    this.MAXFPS = 60;
    this.el = el;
...
Timer.prototype.timerRun = function() {
    var self = this;
    if (self.TIME_ELAPSED >= self.TIMER_DURATION) window.location.href = 'cart'; // return false;
